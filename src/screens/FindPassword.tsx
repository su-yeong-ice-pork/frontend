...
const FindPassword = ({navigation}) => {
    ...
    <View style={styles.inputContainer2}>
          <Text style={styles.inputLabel}>기존 이름 입력 <Text style={styles.starmark}>*</Text></Text>
    ...
    <View style={styles.inputContainer}>
        ...
        <View style={styles.inputContainer}>
          <View style={[styles.inputRow, { borderBottomWidth: 1.5, borderBottomColor: '#A9A9A9' }]}>
            ...
            <TouchableOpacity style={styles.verifyButton}>
              <Text style={styles.verifyButtonText} onPress={verifiedEmail}>확인</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        {askCode=='재요청' && chkEmail && (
            <View style={styles.inputContainer2}>
            <Text style={styles.inputLabel}>비밀번호 재설정 <Text style={styles.starmark}>*</Text></Text>
            <View style={styles.inputWrapper}>
            <TextInput
            style={styles.inputBox}
